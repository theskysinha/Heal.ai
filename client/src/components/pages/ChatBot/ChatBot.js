  ...
  return (
    ...
    <div>
      ...
      <ul className="chatlist">
        ...
        <li className="bot__output bot__output--standard">
          <span className="bot__output--second-sentence">How are you feeling today?</span>
    ...
    <div className="chatbox-area">
      <form action="" id="chatform">
        <textarea placeholder="Talk to me!" className="chatbox" name="chatbox" minLength="2"></textarea>
